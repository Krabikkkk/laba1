...
class Subscription:
    ...
    def __init__(self, type_sub: str, start_date: str, end_date: str, user_ID: int):
        self.user_ID = self.check_subscription_user_id(user_ID)
        self.type_sub = self.check_subscription_type(type_sub)
        self.start_date = self.check_subscription_date(start_date, "дата начала")
        self.end_date = self.check_subscription_date(end_date, "дата окончания")
